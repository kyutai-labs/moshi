...
class CompressionModel(ABC, StreamingModule):
    ...
    @abstractmethod
    def forward(self, x: mx.array) -> qt.QuantizedResult: ...
    ...
    @abstractmethod
    def decode(self, codes: mx.array, scale: tp.Optional[mx.array] = None):
        """See `EncodecModel.decode`."""
        ...

    @abstractmethod
    def decode_latent(self, codes: mx.array):
...
class EncodecModel(CompressionModel):
    ...
    def postprocess(
        self, x: mx.array, scale: tp.Optional[mx.array] = None
    ) -> mx.array:
    ...
    def _normalized_masked_mse(
        mae_estimate: mx.array, unmasked: mx.array, mask: mx.array
    ):
    ...
    def forward(self, x: mx.array) -> qt.QuantizedResult:
        ...
        extra_metrics: tp.Dict[str, mx.array] = {}
    ...
    def _encode_to_unquantized_latent(
        ...
        Args:
            x (mx.array): Float tensor of shape [B, C, T].
    ...
    def encode(
        ...
        Returns:
            codes, scale (tuple of mx.array, mx.array): Tuple composed of:
    ...
    def encode_to_latent(self, x: mx.array, quantize: bool = True) -> mx.array:
    ...
    def decode(self, codes: mx.array, scale: tp.Optional[mx.array] = None):
        ...
        Args:
            codes (mx.array): Int tensor of shape [B, K, T]
            scale (mx.array, optional): Float tensor containing the scale value.

        Returns:
            out (mx.array): Float tensor of shape [B, C, T], the reconstructed audio.
        """
