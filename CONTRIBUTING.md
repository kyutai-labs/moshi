...
If you agree, copy the following statement in your PR, changing your Github Handle:
...
> to the project’s source code submitted via pull requests. I acknowledge that any contributions
> to the AI model itself, such as its architecture, weights, or core functionality, are prohibited
> unless explicitly authorized by Kyutai-labs. I accept that Kyutai-labs has full discretion to
