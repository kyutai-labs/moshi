...
from ..conditioners import ConditionAttributes, WavCondition
...
class MusicGen:
    ...
    def _prepare_tokens_and_attributes(
    ...
    ) -> tp.Tuple[tp.List[ConditionAttributes], tp.Optional[torch.Tensor]]:
        ...
        """
        attributes = [
            ConditionAttributes(text={'description': description})
    ...
    def _generate_tokens(self, attributes: tp.List[ConditionAttributes],
                         prompt_tokens: tp.Optional[torch.Tensor], progress: bool = False) -> torch.Tensor:
        """Generate discrete audio tokens given audio prompt and/or conditions.

        Args:
            attributes (list of ConditionAttributes): Conditions used for generation (text/melody).
